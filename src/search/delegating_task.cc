...
int DelegatingTask::get_num_operator_effects(int op_index, int outcome, bool is_axiom) const {
    return parent->get_num_operator_effects(op_index, outcome , is_axiom);
}
int DelegatingTask::get_num_operator_outcomes(int op_index, bool is_axiom) const {
    return parent->get_num_operator_outcomes(op_index, is_axiom);
}
...
pair<int, int> DelegatingTask::get_operator_effect(
    int op_index, int outcome, int eff_index, bool is_axiom) const {
    return parent->get_operator_effect(op_index,outcome , eff_index, is_axiom);
}
