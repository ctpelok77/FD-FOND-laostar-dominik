...
public:
    ...
    virtual int get_num_operator_effects(int op_index, int outcome, bool is_axiom) const = 0;
    virtual int get_num_operator_outcomes(int op_index, bool is_axiom) const = 0;
    virtual int get_num_operator_effect_conditions(int op_index, int eff_index, bool is_axiom) const = 0;
    ...
    virtual std::pair<int, int> get_operator_effect(
        int op_index, int outcome, int eff_index, bool is_axiom) const = 0;
