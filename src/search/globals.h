...
void dump_goal();
void write_and_verify_version(std::ostream &out);
void write_metric(std::ostream &out);
void write_variables(std::ostream &out);
void write_mutexes(std::ostream &out);

void write_goal(std::ostream &out);
void write_operators(std::ostream &out);
void write_axioms(std::ostream &out);
void write_everything(std::ostream &out);
